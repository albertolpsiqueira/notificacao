...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        try {
            ...
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mensagem, true, String.valueOf(StandardCharsets.UTF_8));
            ...
            String template = templateEngine.process("notificaccao", context);
